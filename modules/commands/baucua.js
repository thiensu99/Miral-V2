...
module.exports.config = {
  ...
  module.exports.run = async function({ api, event, args, Currencies, getText, permssion }) {
    try {
      ...
      // sendMessage
      api.sendMessage({
        body: '𝐍𝐡𝐨̉ 𝐦𝐚̀ 𝐜𝐨̛̀ 𝐛𝐚̣𝐜, 𝐥𝐨̛́𝐧 𝐥𝐞̂𝐧 𝐜𝐡𝐢̉ 𝐜𝐨́ 𝐚̆𝐧 𝐦𝐚̀𝐲 🐸.',
        ...
        setTimeout(() => {
          ...
          if (check >= 0 || check2 == true) {
            return api.sendMessage({
              body: `🌸 𝐋𝐚̆́𝐜 𝐝𝐮̛𝐨̛̣𝐜: ${icon1} | ${icon2} | ${icon3}\n🌸 𝐓𝐢𝐞̂̀𝐧 𝐭𝐡𝐚̆́𝐧𝐠 𝐝𝐮̛𝐨̛̣𝐜 𝐧𝐠𝐨̣𝐭 𝐠𝐚̂́𝐩 𝐝𝐨̂𝐢 𝐭𝐢𝐞̂̀𝐧 𝐤𝐢𝐞̂́𝐦 𝐝𝐮̛𝐨̛̣𝐜.\n+${moneyBet * 3}$`,
              attachment: listimg
            }, threadID, () => Currencies.increaseMoney(senderID, moneyBet * 3), messageID);
          }
          else if (check < 0 || check2 == false) {
            return api.sendMessage({
              body: `🌸 𝐋𝐚̆́𝐜 𝐝𝐮̛𝐨̛̣𝐜: ${icon1} | ${icon2} | ${icon3}\n🌸 𝐂𝐨̀𝐧 𝐭𝐡𝐨̛̉ 𝐜𝐨̀𝐧 𝐠𝐨̛̃ :)))\n-${moneyBet}$`,
              attachment: listimg
