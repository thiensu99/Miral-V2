...
var coinscn = Math.floor(Math.random() * 15000) + 5000; //random coins khi làm ở khu công nghiệp
var coinsdv = Math.floor(Math.random() * 20000) + 5000; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 18000) + 5000; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 30000) + 5000; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 34000) + 5000; //random coins khi đào đá
var coinsdd1 = Math.floor(Math.random() * 50000) + 7000; //random coins khi đào đá
